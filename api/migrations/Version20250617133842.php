 ...
 */
final class Version20250617133842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, sales_list_id INT NOT NULL, delivery_date DATE NOT NULL, delivery_address VARCHAR(50) NOT NULL, delivery_number VARCHAR(20) NOT NULL, delivery_status ENUM('in_preparation','in_progress','delivered') NOT NULL COMMENT '(DC2Type:delivery_status_enum)', driver_remark LONGTEXT DEFAULT NULL, qr_code LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_3781EC1033576AEB (sales_list_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, warehouse_id INT NOT NULL, product_name VARCHAR(50) NOT NULL, quantity DOUBLE PRECISION NOT NULL, net_price DOUBLE PRECISION NOT NULL, gross_price DOUBLE PRECISION NOT NULL, unit_weight DOUBLE PRECISION NOT NULL, category ENUM('flour','oil','egg','yeast','salt','sugar','butter','milk','seed','chocolate','bread') NOT NULL COMMENT '(DC2Type:product_category_enum)', stock_quantity INT NOT NULL, INDEX IDX_D34A04AD5080ECDE (warehouse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE sales_list (id INT AUTO_INCREMENT NOT NULL, status ENUM('pending','preparing_products','awaiting_delivery') NOT NULL COMMENT '(DC2Type:sales_status_enum)', products_price DOUBLE PRECISION NOT NULL, global_discount INT NOT NULL, issue_date DATETIME NOT NULL, expiration_date DATETIME NOT NULL, order_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, supplier_name VARCHAR(255) NOT NULL, supplier_address VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE truck (id INT AUTO_INCREMENT NOT NULL, delivery_id INT DEFAULT NULL, warehouse_id INT NOT NULL, driver_id INT DEFAULT NULL, registration_number VARCHAR(50) NOT NULL, truck_type ENUM('monocuve', 'porteur_palettes', 'autre') NOT NULL COMMENT '(DC2Type:truck_category_enum)', is_available TINYINT(1) NOT NULL, delivery_count INT NOT NULL, transport_distance DOUBLE PRECISION NOT NULL, transport_fee DOUBLE PRECISION NOT NULL, INDEX IDX_CDCCF30A12136921 (delivery_id), INDEX IDX_CDCCF30A5080ECDE (warehouse_id), INDEX IDX_CDCCF30AC3423909 (driver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
